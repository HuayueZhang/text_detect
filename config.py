...
# model_type = 'vgg16'
# model_type = 'vgg16_dssd'
model_type = 'vgg16_dssd_ssd'
...
elif model_type =='vgg16_dssd':
    from nets import pixel_link_symbol1 as pixel_link_symbol
    feat_fuse_type = pixel_link_symbol.FUSE_TYPE_cascade_upsample_sum_conv1x1_deconv2x2
else:  # 'vgg16_dssd_ssd'
...
img_shape = (512, 512)
num_classes_ssd = 5
feat_layers = ['F11', 'F10', 'F9', 'F8', 'F7', 'F4', 'F3']
strides = [1]
feat_shapes = [(2, 2), (4, 4), (8, 8), (16, 16), (32, 32), (64, 64), (128, 128)]
anchor_size_bounds = [0.15, 0.90]
anchor_sizes=[(184., 208., 232., 256.),
              (124., 136., 148., 160.),
              (88., 96., 104., 112.),
              (56., 64., 72., 80.),
              (36., 40., 44., 48.),
...
anchor_steps  = [256, 128, 64, 32, 16, 8, 4]
anchor_offset = 0.5
