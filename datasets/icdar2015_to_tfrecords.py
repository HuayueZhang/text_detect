...
if __name__ == "__main__":
    root_dir = util.io.get_absolute_path('~/pixel_link/dataset/ICDAR2015/Challenge4/')
    output_dir = util.io.get_absolute_path('~/pixel_link/dataset/ICDAR2015/')
    ...
    cvt_to_tfrecords(output_path = util.io.join_path(output_dir, 'icdar2015_train.tfrecord'),
